  ...
  Stream.prototype.token = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.streamInfo()];
          case 1:
            return [2 /*return*/, _a.sent().token];
        }
      });
    });
  };
...
var StreamManager = /** @class */ (function () {
  ...
  StreamManager.prototype.create = function (
    token,
    amountPerSecond,
    reason,
    startTime,
      ...
      return __generator(this, function (_g) {
        switch (_g.label) {
          case 0:
            if (
              !accountOverride &&
              !((_a = this.walletClient) === null || _a === void 0
                ? void 0
                : _a.account)
            )
            ...
            account =
              ...
              ((_d =
                (_c =
                  (_b = this.walletClient) === null || _b === void 0
                    ? void 0
                    : _b.account) === null || _c === void 0
                  ? void 0
                  : _c.address) !== null && _d !== void 0
                ? _d
                : "0x0");
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              (_e = this.walletClient) === null || _e === void 0
                ? void 0
                : _e.writeContract({
                    chain: null,
                    address: this.address,
